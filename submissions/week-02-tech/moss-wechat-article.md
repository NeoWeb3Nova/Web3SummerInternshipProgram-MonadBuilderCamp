...
> 现行架构请读修订版：[`moss-wechat-article-v2.md`](./moss-wechat-article-v2.md)  
...
![直接调用与可验证 Plan 的安全差异](imgs/moss/02-comparison-call-vs-verify.png)
...
![双 tracer 模拟如何提取 effects 并与 expects 对账](imgs/moss/03-flowchart-dual-tracer.png)
