...
- 钱包地址 `0x650cd30a58e6893169F41CaC9379D02e7E34653F` 在 Monad Testnet 上已完成多笔交易，MonadScan 已收录。
- 其中一笔为合约部署，新合约地址为 `0xb02956728ef9b72adb805a5507024216dd8f0cba`。
...
| 字段 | 值 | 说明 |
|------|-----|------|
| 钱包地址 | `0x650cd30a58e6893169F41CaC9379D02e7E34653F` | 公开地址，用于接收测试 MON 和部署合约 |
| 交易 1 | 合约部署 | 部署了一个合约（method 为 `0x60806040`即创建合约） |
| 交易 1 哈希 | `0x1b552a774e6f33dc0dfbc03890ebaedd007e6a38d9557b5a3205a9f5943a98ed` | [MonadScan](https://testnet.monadscan.com/tx/0x1b552a774e6f33dc0dfbc03890ebaedd007e6a38d9557b5a3205a9f5943a98ed) |
| 交易 1 Gas / Fee | 0.04211319 MON | 合约创建费用 |
| 交易 2 | 测试转账 IN | 从 `0x46A0E810...D1968D49a` 收到 10 MON |
| 交易 2 哈希 | `0xa760432eb5576ef5b0b5be766279fba20675180ef4263bc48b01f260ddc9fac0` | [MonadScan](https://testnet.monadscan.com/tx/0xa760432eb5576ef5b0b5be766279fba20675180ef4263bc48b01f260ddc9fac0) |
| 交易 3 | 测试转账 IN | 从 `0x46A0E810...D1968D49a` 收到 10 MON |
| 交易 3 哈希 | `0xb161638f001a63a3fbdae200213690059f4b14fe88619e610146b0246530cd8b` | [MonadScan](https://testnet.monadscan.com/tx/0xb161638f001a63a3fbdae200213690059f4b14fe88619e610146b0246530cd8b) |
| 新合约地址 | `0xb02956728ef9b72adb805a5507024216dd8f0cba` | [MonadScan](https://testnet.monadscan.com/address/0xb02956728ef9b72adb805a5507024216dd8f0cba) |
| 状态 | 已确认 | MonadScan 已收录，交易正常 |
...
- 已完成真实链上合约部署：交易哈希 `0x1b552a...a98ed`，部署新合约 `0xb029...f0cba`。
